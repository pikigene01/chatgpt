...
const {user_icon,chatHistory,sendMessage,setInputValue,inputValue,componentToView,setComponentToView} = useContext(AppContext);
  ...
  return (
    ...
    {hide && (
        <div class="tyn-chat-body-side m-4 rounded-3" style={{width:"400px",background:"var(--bs-primary-50)"}}>
        <div class="tyn-qa">
            <div class="tyn-qa-item-riskcurb" style={{height:"40vh",overflow:"hidden scroll"}}>
                <div class="tyn-qa-message tyn-text-block" style={{textAlign:"center"}}> Chat Responses </div>
            </div>
            <div class="tyn-qa-item-riskcurb" style={{height:"30vh",overflow:"hidden scroll"}}>
                <div class="tyn-qa-message tyn-text-block" style={{textAlign:"center"}}> Select Options</div>
                <ol style={{display:'flex',flexDirection:'column',justifyContent:'center',alignItems:'center'}}>
                    <li>Option 1</li>
                    <li>Option 2</li>
                    <li>Option 3</li>
                </ol>
    ...
    {!hide && (
        <>
    <div class="tyn-chat-body m-4 rounded-3" style={{width:"400px"}} data-simplebar>
        <div class="tyn-qa">
            <div class="tyn-qa-item">
                ...
                <div class="tyn-qa-message tyn-text-block"> What is your company name ? </div>
            </div>
...
<input placeholder='type to answer here....' style={{width:'100%',background:'none',outline:'none',border:'none'}} type="text" value={inputValue} onChange={event => setInputValue(event.target.value)} />
